/*Computer Graphics P16: Write a Graphic program to rotate a  
 * Polygon using pivot-point in which values of polygon edges, pivot-point and rotation angle
...
public class P16PivotRotatePolygonMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblRotate, lblPivot;
    TextField tfx, tfy, tftheta, tfpx, tfpy;
    Button btnDraw, btnRotate;
    Panel p1;
    P16PivotRotatePolygonCanvas can = new P16PivotRotatePolygonCanvas();
    
    public P16PivotRotatePolygonMain(){
        
        super("Practical:16 Polygon Rotation using Pivot-Point...");
