/*Computer Graphics P15: Write a Graphic program to scale a  
...
public class P15ScalePolygonMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblScale;
    TextField tfx, tfy, tfsx, tfsy;
    Button btnDraw, btnScale;
    Panel p1;
    P15ScalePolygonCanvas can = new P15ScalePolygonCanvas();
    
    public P15ScalePolygonMain(){
        
        super("Practical:15 Polygon Scaling...");
