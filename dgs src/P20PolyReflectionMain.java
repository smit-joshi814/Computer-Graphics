...
public class P20PolyReflectionMain extends Frame implements ActionListener{
    ...
    P20PolyReflectionCanvas can = new P20PolyReflectionCanvas();
    
    public P20PolyReflectionMain(){
        
        super("Practical:20 Polygon Reflaction...");
