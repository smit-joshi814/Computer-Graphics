/*Computer Graphics P21: Write a Graphic program to shear a  
...
public class P21ShearPolygonMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblTranslate;
    TextField tfx, tfy, tfsh, tfaxe;
    Button btnDraw, btnShear;
    Panel p1;
    P21ShearPolygonCanvas can = new P21ShearPolygonCanvas();
    
    public P21ShearPolygonMain(){
        
        super("Practical:21 Shear Polygon...");
