/*Computer Graphics P17: Write a Graphic program to scale a  
 * Polygon using fixed point in which values of polygon edges, fixed point and 
 * scaling points will be given by user.
 */
...
public class P17FixedScalePolyMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblScale, lblPoint;
    TextField tfx, tfy, tfsx, tfsy, tffx, tffy;
    Button btnDraw, btnScale;
    Panel p1;
    P17FixedScalePolyCanvas can = new P17FixedScalePolyCanvas();
    
    public P17FixedScalePolyMain(){
        
        super("Practical:17 Polygon Scaling on Fixed Point...");
