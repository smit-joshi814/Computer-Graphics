...
package p19compositTransCanvas;
import java.awt.*;
import java.awt.geom.*;
import java.util.StringTokenizer;

public class P19CompositTransCanvas extends Canvas {
    ...
    public void transformPoly(String xc, String yc, double tx, double ty, double sx, double sy, int theta ){
        ...
        for(int angle=0; angle<theta; angle++){
            ...
            //First Row
            trans[0][0]= sx*(Math.cos(rad));
            trans[0][1]= -sx*(Math.sin(rad));
            trans[0][2]= tx;
            
            //Second Row
            trans[1][0]=sy*(Math.sin(rad));
            trans[1][1]= sy*(Math.cos(rad));
            trans[1][2]=ty;
