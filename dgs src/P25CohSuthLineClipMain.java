/*Computer Graphics P25: Write a Graphic program for Cohen-Sutherland
...
public class P25CohSuthLineClipMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblWinMin, lblWinMax;
    TextField tfx, tfy, tfxwmn, tfywmn, tfxwmx, tfywmx; 
    Button btnDraw, btnClip;
    Panel p1;
    P25CohSuthLineClipCanvas can = new P25CohSuthLineClipCanvas();
    
    public P25CohSuthLineClipMain(){
        
        super("Practical:25 Cohen-Sutherland Line Clipping...");
