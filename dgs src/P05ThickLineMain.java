/*Computer Graphics P05: Write a Graphic program to draw Thickline using DDA 
 * line draw algorithm.
 */
...
public class P05ThickLineMain extends Frame implements ActionListener{
    
    Label lblCoord1, lblCoord2;
    TextField tfx1, tfx2, tfy1, tfy2;
    Button btnDraw, btnReset;
    Panel p1;
    P05ThickLineCanvas can = new P05ThickLineCanvas();
    
    public P05ThickLineMain(){
        
        super("Practical:05 ThickLine using DDA Line Drawing...");
