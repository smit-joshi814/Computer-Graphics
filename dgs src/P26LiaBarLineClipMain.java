/*Computer Graphics P26: Write a Graphic program for Lian-Barsky
...
public class P26LiaBarLineClipMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblWinMin, lblWinMax;
    TextField tfx, tfy, tfxwmn, tfywmn, tfxwmx, tfywmx; 
    Button btnDraw, btnClip;
    Panel p1;
    P26LiaBarLineClipCanvas can = new P26LiaBarLineClipCanvas();
    
    public P26LiaBarLineClipMain(){
        
        super("Practical:26 Liang-Barsky Line Clipping...");
