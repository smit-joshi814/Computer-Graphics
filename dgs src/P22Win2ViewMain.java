/*Computer Graphics P22: Write a Graphic program to translate a polygon
...
public class P22Win2ViewMain extends Frame implements ActionListener{
    ...
    Panel p1;
    P22Win2ViewCanvas can = new P22Win2ViewCanvas();
    
    public P22Win2ViewMain(){
        
        super("Practical:22 Polygon Clipping [Window-to-Viewport]...");
