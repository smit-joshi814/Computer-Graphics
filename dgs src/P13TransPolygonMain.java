/*Computer Graphics P13: Write a Graphic program to translate a  
...
public class P13TransPolygonMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblTranslate;
    TextField tfx, tfy, tftx, tfty;
    Button btnDraw, btnTranslate;
    Panel p1;
    P13TransPolygonCanvas can = new P13TransPolygonCanvas();
    
    public P13TransPolygonMain(){
        
        super("Practical:13 Polygon Translation...");
